...
print(accuracy)
print()
# clf.predict(x_test) #this is to predict the y values for x test data
# pred = clf.predict(x_test) #this is to give the predicted values to a variable so that it may be printed
# print(pred)
# print(x_test)
